...
import { DataTableSearchPipe, DataTableSearchNumbersPipe, StringToBooleanPipe, StringToBooleanNotPipe,StatusLong,BoooleanToNumberPipe,ZeroToOtros,NumbersPlayed,DateToLocale, OrigenLong } from '../pipes/data-table-search.pipe';
...
import { OthersComponent } from './G-Office/others/others.component';
