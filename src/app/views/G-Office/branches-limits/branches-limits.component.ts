...
@Component({
  selector: 'app-branches-limits',
  templateUrl: './branches-limits.component.html',
  styleUrls: ['./branches-limits.component.scss']
})
export class BranchesLimitsComponent implements OnInit {
  public list:IBranch[]=[];
...
//    this.service.theTerminalsReset();
  ...
  getOne(id: any) {
    ...
    this.openModal('Actualizar Limites Ventas Banca o Sucursal')
    this.form = new FormGroup({
