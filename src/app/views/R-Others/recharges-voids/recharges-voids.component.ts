...
@Component({
  selector: 'app-recharges-voids',
  templateUrl: './recharges-voids.component.html',
  styleUrls: ['./recharges-voids.component.scss']
})
export class RechargesVoidsComponent implements OnInit {
  public list:IReport[]=[];
  public criteria:ICriteria= {
    Name:"report_recharges_voids",
...
this.page=1;
  ...
  generatePdf() {
    if (this.list.length > 0) {
      ...
      let title = `Recargas Anuladas Del: ${this.form.value['date1']} Al: ${this.form.value['date2']}`
