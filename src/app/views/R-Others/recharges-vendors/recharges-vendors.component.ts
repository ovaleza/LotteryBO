...
@Component({
  selector: 'app-recharges-vendors',
  templateUrl: './recharges-vendors.component.html',
  styleUrls: ['./recharges-vendors.component.scss']
})
export class RechargesVendorsComponent implements OnInit {
  public list:IReport[]=[];
  public criteria:ICriteria= {
    Name:"report_recharges_sales",
