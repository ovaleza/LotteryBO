...
@Component({
  selector: 'app-r-prize-payment',
  templateUrl: './r-prize-payment.component.html',
  styleUrls: ['./r-prize-payment.component.scss']
})
export class RPrizePaymentComponent implements OnInit {
  public list:IReport[]=[];
  public criteria:ICriteria= {
    Name:"view_prize_payments",
