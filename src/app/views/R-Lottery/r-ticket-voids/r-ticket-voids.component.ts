...
@Component({
  selector: 'app-r-ticket-voids',
  templateUrl: './r-ticket-voids.component.html',
  styleUrls: ['./r-ticket-voids.component.scss']
})
export class RTicketVoidsComponent implements OnInit {
  public list:IReport[]=[];
  public criteria:ICriteria= {
    Name:"report_ticket_voids",
