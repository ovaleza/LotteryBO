...
@Component({
  selector: 'app-r-ln-sales',
  templateUrl: './r-ln-sales.component.html',
  styleUrls: ['./r-ln-sales.component.scss']
})
export class RLNSalesComponent implements OnInit {
  public list:IReport[]=[];
  public criteria:ICriteria= {
    Name:"report_ln_sales",
  ...
  generatePdf() {
    if (this.list.length > 0) {
      ...
      let title = `Ventas Loteria Nacional Del: ${this.form.value['date1']} Al: ${this.form.value['date2']}`
