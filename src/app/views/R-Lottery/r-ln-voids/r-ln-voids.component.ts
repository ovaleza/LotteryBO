...
@Component({
  selector: 'app-r-ln-voids',
  templateUrl: './r-ln-voids.component.html',
  styleUrls: ['./r-ln-voids.component.scss']
})
export class RLNVoidsComponent implements OnInit {
  public list:IReport[]=[];
  public criteria:ICriteria= {
    Name:"report_ln_voids",
...
this.page=1;
  ...
  generatePdf() {
    if (this.list.length > 0) {
      ...
      let title = `Anulados Loteria Nacional Del: ${this.form.value['date1']} Al: ${this.form.value['date2']}`
