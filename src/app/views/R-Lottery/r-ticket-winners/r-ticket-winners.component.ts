...
@Component({
  selector: 'app-r-ticket-winners',
  templateUrl: './r-ticket-winners.component.html',
  styleUrls: ['./r-ticket-winners.component.scss']
})
export class RTicketWinnersComponent implements OnInit {
  public list:IReport[]=[];
  public criteria:ICriteria= {
    Name:"report_ticket_winners",
...
this.page=1;
  ...
  generatePdf() {
    if (this.list.length > 0) {
      ...
      let title = `Reporte Tickets Ganadores Del: ${this.form.value['date1']} Al: ${this.form.value['date2']}`
